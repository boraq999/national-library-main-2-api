      ...
      <Box 
        sx={{ 
          ...
          ...(theme.palette.mode === 'light' && {
            backgroundImage: 'linear-gradient(rgba(208, 215, 222, 0.2) 1px, transparent 1px), linear-gradient(to right, rgba(208, 215, 222, 0.2) 1px, transparent 1px)',
            backgroundSize: '50px 50px',
          }),
          ...(theme.palette.mode === 'dark' && {
            backgroundImage: 'linear-gradient(rgba(48, 54, 61, 0.2) 1px, transparent 1px), linear-gradient(to right, rgba(48, 54, 61, 0.2) 1px, transparent 1px)',
            backgroundSize: '50px 50px',
